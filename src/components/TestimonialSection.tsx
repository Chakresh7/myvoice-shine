    ...
    <div className="container mx-auto max-w-[1100px]">
      <ScrollReveal>
        <h2 className="font-heading font-bold text-[30px] md:text-[46px] leading-[1.1] mb-14 tracking-[-0.01em]">
          What the <span className="text-radium">first users</span> are saying.
        </h2>
      </ScrollReveal>
      ...
      <ScrollReveal delay={0.15}>
        <div className="glass-card p-10 md:p-16 relative overflow-hidden">
          ...
          <p className="font-heading font-semibold text-[13px] opacity-65 tracking-wide">
      ...
      <ScrollReveal delay={0.25}>
        <div className="flex flex-wrap justify-center gap-3 mt-10">
          {["3× more profile views", "Higher reply rates", "Zero burnout"].map((s) => (
            <span key={s} className="glass-pill text-[11px] opacity-70 font-body">{s}</span>
          ))}
        </div>
      </ScrollReveal>
    </div>
